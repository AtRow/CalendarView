...
public class RealViewSwitcher extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (widthMode != MeasureSpec.EXACTLY) {
			throw new IllegalStateException("RealViewSwitcher can only be used in EXACTLY mode.");
		}
	...
	/**
	 * Sets the {@link com.examples.android.calendar.RealViewSwitcher.OnScreenSwitchListener}.
	 * 
